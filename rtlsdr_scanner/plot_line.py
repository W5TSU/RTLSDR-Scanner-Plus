...
class Plotter(object):
            ...
            if self.settings.autoL or force:
                ...
                if self.settings.plotFunc == PlotFunc.VAR and len(self.axes.collections) > 0:
                    ...
                    try:
                        ...
                        self.barBase.mappable.set_clim((norm.vmin, norm.vmax))
                else:
                    try:
    ...
    def set_colourmap(self, colourMap):
        ...
        try:
            ...
            # matplotlib >= 3.3 removed set_cmap, use mappable.set_cmap instead
            self.barBase.mappable.set_cmap(colourMap)
        try:
            self.barBase.draw_all()
        except:
            pass
    ...
    def __get_norm(self, autoL, extent):
        if autoL:
            try:
                ...
                # get_clim() was deprecated, use mappable.get_clim() instead
